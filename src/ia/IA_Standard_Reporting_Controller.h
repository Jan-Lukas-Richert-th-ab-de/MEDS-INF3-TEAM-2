...
public:
public:
    IA_Standard_Reporting_Controller(AR_UCI_Standard_Reporting_IB &uci, AR_UCI_Doctor_Administration_IB &doctor_uci, AR_UCI_Patient_Administration_IB &patient_uci, AR_UCI_Room_Administration_IB &room_uci);
