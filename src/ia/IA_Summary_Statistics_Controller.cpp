...
IA_Summary_Statistics_Controller::IA_Summary_Statistics_Controller (AR_UCI_Summary_Statistics_Administration_IB &uci)
    : resource_uci(uci){};
...
void IA_Summary_Statistics_Controller::control_update()
{
