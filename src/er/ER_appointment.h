...
public:
    ...
    ER_Appointment(std::string d, std::string m, std::string y, std::string ts, std::string t, ER_Doctor a_doctor, ER_Patient a_patient, ER_Room a_room);                  // d, m, y, ts, t
    ER_Appointment(unsigned int id, std::string d, std::string m, std::string y, std::string ts, std::string t, ER_Doctor a_doctor, ER_Patient a_patient, ER_Room a_room); // d, m, y, ts, t
    ...
    void set_doctor(ER_Doctor a_doctor);
    void set_patient(ER_Patient a_patient);
    void set_room(ER_Room a_room);
...
=======
    ...
    std::string time_start{}; // Zeitanfang++++wann?
    std::string time{};       // Termindauer++++++++++wie lange?
>>>>>>> fae2f6823d2893b815b34bac7b223e082b998b79

    ER_Doctor a_doctor;
    ER_Patient a_patient;
    ER_Room a_room;
};
