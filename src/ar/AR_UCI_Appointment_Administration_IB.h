...
class AR_UCI_Appointment_Administration_IB {
   public:
      ...
      virtual void create(std::string day, std::string month, std::string year) = 0; //d, m +y
      virtual void update(unsigned int id, std::string day, std::string month, std::string year) = 0; //d, m +y
