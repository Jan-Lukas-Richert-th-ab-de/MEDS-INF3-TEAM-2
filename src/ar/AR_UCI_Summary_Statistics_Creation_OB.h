...
virtual void present_report_doctor_Summary_Statistics(const std::vector<std::map<std::string, std::string>>& data) {};
virtual void present_report_room_occupancy_Summary_Statistics(const std::vector<std::map<std::string, std::string>>& data) {};
