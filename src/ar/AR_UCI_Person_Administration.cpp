...
AR_UCI_Person_Administration::AR_UCI_Person_Administration(
...
void AR_UCI_Person_Administration::list_all(){
...
void AR_UCI_Person_Administration::create(std::string first_name, std::string last_name){
  ER_Person a_person{first_name, last_name};
  resource_repository.save(a_person);
  list_all();
};
void AR_UCI_Person_Administration::update(unsigned int id, std::string first_name, std::string last_name){
...
void AR_UCI_Person_Administration::remove(unsigned int id){
  resource_repository.remove(id);
  list_all();
};

std::map<std::string, std::string> AR_UCI_Person_Administration::get_data_map_for_person(const ER_Person& a_person){
...
void AR_UCI_Person_Administration::sort_persons_by_id (std::vector<ER_Person>& person_list) {
